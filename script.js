...
function preload() {
  // body language, everything i wanted, its you, the good side, & the year of the monkey work best
  song = loadSound('maanmerijaan.mp3')
  // song = loadSound('all-your-friends.mp3')
  // song = loadSound('roll-with-me.mp3')
  // song = loadSound('silver.mp3')
  fft = new p5.FFT()
}
